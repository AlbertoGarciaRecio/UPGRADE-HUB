...
let cucuAlien = aliens.find(alien => alien.name === "Cucushumushu");
let poromMutation = mutations.find(mutation => mutation.name ==="Porompompero");

cucuAlien.mutation = poromMutation;